...
#mm twitter
#th train_sergio.lua -input_code 434 -save_output 1 > /homedtic/fbarbieri/logs/mmsergio434 &
th train_sergio.lua -input_code 664 -save_output 1 -feat_size_visual 200 > /homedtic/fbarbieri/logs/mmsergio664 &
