...
cmd:option('-train_size', 21384, 'how many users to use for training set')
cmd:option('-val_size', 500, 'how many users to use for validation set') --4680
cmd:option('-test_size', 4649, 'how many users to use for test set')
...
cmd:option('-output_path', '/home/fbarbieri/imagemusic/results/', 'folder to save output vectors')
...
local function save_output_vectors(rank)
  ...
  for dataCount = 1, 3 do
    ...
    elseif dataset == 'val' then
      size = 4680 --opt.val_size --ALEEEERRRRTTTT!!!!!!!!!!!!!! im using a smaller val to be faster
